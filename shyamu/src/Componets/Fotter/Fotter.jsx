...
const Fotter = () => {
  return (
    <>
    <div className=' sm:max-w-[550px] sm:m-auto md:max-w-[700px] md:mt-10  lg:max-w-[900px] xl:max-w-[1120px] xl:m-auto xl:mt-20  2xl:max-w-[1400px]'>
  ...
  <div className='xl:max-w-[1120px] xl:m-auto sm:max-w-[550px] sm:m-auto md:max-w-[700px] md:m-auto lg:max-w-[900px] lg:m-auto 2xl:max-w-[1400px]'><hr className='mt-5'></hr>
